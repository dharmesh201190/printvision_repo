...
class Interceptor extends \StripeIntegration\Payments\Block\Success implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isWechatPaymentMethod');
        if (!$pluginInfo) {
            return parent::isWechatPaymentMethod();
        } else {
            return $this->___callPlugins('isWechatPaymentMethod', func_get_args(), $pluginInfo);
        }
    }
