...
class Interceptor extends \StripeIntegration\Payments\Block\Minicart\Shortcut implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getApplePayParams');
        if (!$pluginInfo) {
            return parent::getApplePayParams();
        } else {
            return $this->___callPlugins('getApplePayParams', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductApplePayParams');
        if (!$pluginInfo) {
            return parent::getProductApplePayParams();
        } else {
            return $this->___callPlugins('getProductApplePayParams', func_get_args(), $pluginInfo);
        }
    }
