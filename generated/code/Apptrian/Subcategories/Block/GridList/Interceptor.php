<?php
namespace Apptrian\Subcategories\Block\GridList;

/**
 * Interceptor class for @see \Apptrian\Subcategories\Block\GridList
 */
class Interceptor extends \Apptrian\Subcategories\Block\GridList implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Apptrian\Subcategories\Helper\Data $helper, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubcategoriesData');
        if (!$pluginInfo) {
            return parent::getSubcategoriesData();
        } else {
            return $this->___callPlugins('getSubcategoriesData', func_get_args(), $pluginInfo);
        }
    }
