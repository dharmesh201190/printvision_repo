...
class Interceptor extends \MSP\ReCaptcha\Block\Adminhtml\ReCaptcha implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canDisplayCaptcha');
        if (!$pluginInfo) {
            return parent::canDisplayCaptcha();
        } else {
            return $this->___callPlugins('canDisplayCaptcha', func_get_args(), $pluginInfo);
        }
    }
