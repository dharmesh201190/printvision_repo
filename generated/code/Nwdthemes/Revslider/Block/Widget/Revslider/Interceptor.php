<?php
namespace Nwdthemes\Revslider\Block\Widget\Revslider;

/**
 * Interceptor class for @see \Nwdthemes\Revslider\Block\Widget\Revslider
 */
class Interceptor extends \Nwdthemes\Revslider\Block\Widget\Revslider implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Customer\Model\Session $customerSession, \Nwdthemes\Revslider\Helper\Framework $frameworkHelper, \Nwdthemes\Revslider\Helper\Plugin $pluginHelper, \Nwdthemes\Revslider\Model\Revslider\RevSliderFront $revsliderFront, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $customerSession, $frameworkHelper, $pluginHelper, $revsliderFront, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderSlider');
        if (!$pluginInfo) {
            return parent::renderSlider();
        } else {
            return $this->___callPlugins('renderSlider', func_get_args(), $pluginInfo);
        }
    }
