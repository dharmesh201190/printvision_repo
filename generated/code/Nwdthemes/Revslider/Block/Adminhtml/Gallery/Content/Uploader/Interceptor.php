<?php
namespace Nwdthemes\Revslider\Block\Adminhtml\Gallery\Content\Uploader;

/**
 * Interceptor class for @see \Nwdthemes\Revslider\Block\Adminhtml\Gallery\Content\Uploader
 */
class Interceptor extends \Nwdthemes\Revslider\Block\Adminhtml\Gallery\Content\Uploader implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageUploadMaxWidth');
        if (!$pluginInfo) {
            return parent::getImageUploadMaxWidth();
        } else {
            return $this->___callPlugins('getImageUploadMaxWidth', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageUploadMaxHeight');
        if (!$pluginInfo) {
            return parent::getImageUploadMaxHeight();
        } else {
            return $this->___callPlugins('getImageUploadMaxHeight', func_get_args(), $pluginInfo);
        }
    }
