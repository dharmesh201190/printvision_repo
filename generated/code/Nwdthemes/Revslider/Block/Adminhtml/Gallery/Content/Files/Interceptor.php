<?php
namespace Nwdthemes\Revslider\Block\Adminhtml\Gallery\Content\Files;

/**
 * Interceptor class for @see \Nwdthemes\Revslider\Block\Adminhtml\Gallery\Content\Files
 */
class Interceptor extends \Nwdthemes\Revslider\Block\Adminhtml\Gallery\Content\Files implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Nwdthemes\Revslider\Model\Gallery\Storage $imageStorage, \Nwdthemes\Revslider\Helper\Gallery\Images $imageHelper, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFilesCount');
        if (!$pluginInfo) {
            return parent::getFilesCount();
        } else {
            return $this->___callPlugins('getFilesCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFileId(\Magento\Framework\DataObject $file)
    {
        ...
        if (!$pluginInfo) {
            return parent::getFileId($file);
        } else {
            return $this->___callPlugins('getFileId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFileThumbUrl');
        if (!$pluginInfo) {
            return parent::getFileThumbUrl($file);
        } else {
            return $this->___callPlugins('getFileThumbUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFileWidth');
        if (!$pluginInfo) {
            return parent::getFileWidth($file);
        } else {
            return $this->___callPlugins('getFileWidth', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFileHeight');
        if (!$pluginInfo) {
            return parent::getFileHeight($file);
        } else {
            return $this->___callPlugins('getFileHeight', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFileShortName');
        if (!$pluginInfo) {
            return parent::getFileShortName($file);
        } else {
            return $this->___callPlugins('getFileShortName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImagesWidth');
        if (!$pluginInfo) {
            return parent::getImagesWidth();
        } else {
            return $this->___callPlugins('getImagesWidth', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImagesHeight');
        if (!$pluginInfo) {
            return parent::getImagesHeight();
        } else {
            return $this->___callPlugins('getImagesHeight', func_get_args(), $pluginInfo);
        }
    }
