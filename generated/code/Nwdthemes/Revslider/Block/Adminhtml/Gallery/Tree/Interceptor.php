<?php
namespace Nwdthemes\Revslider\Block\Adminhtml\Gallery\Tree;

/**
 * Interceptor class for @see \Nwdthemes\Revslider\Block\Adminhtml\Gallery\Tree
 */
class Interceptor extends \Nwdthemes\Revslider\Block\Adminhtml\Gallery\Tree implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Nwdthemes\Revslider\Helper\Gallery\Images $cmsWysiwygImages, \Magento\Framework\Registry $registry, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTreeLoaderUrl');
        if (!$pluginInfo) {
            return parent::getTreeLoaderUrl();
        } else {
            return $this->___callPlugins('getTreeLoaderUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRootNodeName');
        if (!$pluginInfo) {
            return parent::getRootNodeName();
        } else {
            return $this->___callPlugins('getRootNodeName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTreeCurrentPath');
        if (!$pluginInfo) {
            return parent::getTreeCurrentPath();
        } else {
            return $this->___callPlugins('getTreeCurrentPath', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTreeWidgetOptions');
        if (!$pluginInfo) {
            return parent::getTreeWidgetOptions();
        } else {
            return $this->___callPlugins('getTreeWidgetOptions', func_get_args(), $pluginInfo);
        }
    }
