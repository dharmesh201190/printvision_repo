<?php
namespace Nwdthemes\Revslider\Block\Adminhtml\SliderOverview;

/**
 * Interceptor class for @see \Nwdthemes\Revslider\Block\Adminhtml\SliderOverview
 */
class Interceptor extends \Nwdthemes\Revslider\Block\Adminhtml\SliderOverview implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Nwdthemes\Revslider\Helper\Framework $framework, \Nwdthemes\Revslider\Helper\Query $query, \Nwdthemes\Revslider\Helper\Curl $curl, \Nwdthemes\Revslider\Helper\Filesystem $filesystemHelper, \Nwdthemes\Revslider\Helper\Images $images, \Magento\Backend\Model\UrlInterface $backendUrl, \Magento\Framework\App\ResourceConnection $resource, \Nwdthemes\Revslider\Model\Revslider\GoogleFonts $googleFonts, \Nwdthemes\Revslider\Helper\Register $registerHelper)
    {
        $this->___init();
        parent::__construct($context, $framework, $query, $curl, $filesystemHelper, $images, $backendUrl, $resource, $googleFonts, $registerHelper);
    }
