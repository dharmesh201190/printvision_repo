<?php
namespace Nwdthemes\Revslider\Block\Adminhtml\SlideEditor;

/**
 * Interceptor class for @see \Nwdthemes\Revslider\Block\Adminhtml\SlideEditor
 */
class Interceptor extends \Nwdthemes\Revslider\Block\Adminhtml\SlideEditor implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Nwdthemes\Revslider\Helper\Data $dataHelper, \Nwdthemes\Revslider\Helper\Framework $framework, \Nwdthemes\Revslider\Helper\Query $query, \Nwdthemes\Revslider\Helper\Curl $curl, \Nwdthemes\Revslider\Helper\Filesystem $filesystemHelper, \Nwdthemes\Revslider\Helper\Images $images, \Magento\Framework\App\ResourceConnection $resource, \Nwdthemes\Revslider\Model\Revslider\GoogleFonts $googleFonts, \Nwdthemes\Revslider\Helper\Register $registerHelper)
    {
        $this->___init();
        parent::__construct($context, $dataHelper, $framework, $query, $curl, $filesystemHelper, $images, $resource, $googleFonts, $registerHelper);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addProductSliderActions');
        if (!$pluginInfo) {
            return parent::addProductSliderActions();
        } else {
            return $this->___callPlugins('addProductSliderActions', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getViewUrl($url, $args = '')
    {
        ...
        if (!$pluginInfo) {
            return parent::getViewUrl($url, $args);
        } else {
