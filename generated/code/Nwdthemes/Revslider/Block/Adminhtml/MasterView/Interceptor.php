<?php
namespace Nwdthemes\Revslider\Block\Adminhtml\MasterView;

/**
 * Interceptor class for @see \Nwdthemes\Revslider\Block\Adminhtml\MasterView
 */
class Interceptor extends \Nwdthemes\Revslider\Block\Adminhtml\MasterView implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Nwdthemes\Revslider\Helper\Framework $framework, \Nwdthemes\Revslider\Helper\Plugin $pluginHelper, \Nwdthemes\Revslider\Helper\Query $query, \Nwdthemes\Revslider\Helper\Register $registerHelper, \Nwdthemes\Revslider\Helper\Curl $curl, \Nwdthemes\Revslider\Helper\Filesystem $filesystemHelper, \Nwdthemes\Revslider\Helper\Images $images, \Magento\Framework\App\ResourceConnection $resource, \Nwdthemes\Revslider\Model\Revslider\GoogleFonts $googleFonts, \Nwdthemes\Revslider\Model\Revslider\RevSliderAdmin $revSliderAdmin, \Nwdthemes\Revslider\Model\Revslider\Framework\RevSliderLoadBalancer $revSliderLoadBalancer)
    {
        $this->___init();
        parent::__construct($context, $framework, $pluginHelper, $query, $registerHelper, $curl, $filesystemHelper, $images, $resource, $googleFonts, $revSliderAdmin, $revSliderLoadBalancer);
    }
