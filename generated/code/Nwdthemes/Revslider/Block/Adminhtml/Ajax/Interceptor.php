<?php
namespace Nwdthemes\Revslider\Block\Adminhtml\Ajax;

/**
 * Interceptor class for @see \Nwdthemes\Revslider\Block\Adminhtml\Ajax
 */
class Interceptor extends \Nwdthemes\Revslider\Block\Adminhtml\Ajax implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Nwdthemes\Revslider\Model\Revslider\RevSliderFront $revSliderFront, \Nwdthemes\Revslider\Model\Revslider\RevSliderAdmin $revSliderAdmin, \Nwdthemes\Revslider\Helper\Framework $frameworkHelper, \Nwdthemes\Revslider\Helper\Plugin $pluginHelper)
    {
        $this->___init();
        parent::__construct($context, $revSliderFront, $revSliderAdmin, $frameworkHelper, $pluginHelper);
    }
