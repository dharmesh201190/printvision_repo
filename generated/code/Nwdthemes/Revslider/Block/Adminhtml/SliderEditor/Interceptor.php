<?php
namespace Nwdthemes\Revslider\Block\Adminhtml\SliderEditor;

/**
 * Interceptor class for @see \Nwdthemes\Revslider\Block\Adminhtml\SliderEditor
 */
class Interceptor extends \Nwdthemes\Revslider\Block\Adminhtml\SliderEditor implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Customer\Model\ResourceModel\Group\Collection $customerGroupCollection, \Nwdthemes\Revslider\Helper\Framework $framework, \Nwdthemes\Revslider\Helper\Query $query, \Nwdthemes\Revslider\Helper\Curl $curl, \Nwdthemes\Revslider\Helper\Filesystem $filesystemHelper, \Nwdthemes\Revslider\Helper\Images $images, \Magento\Framework\App\ResourceConnection $resource, \Nwdthemes\Revslider\Model\Revslider\GoogleFonts $googleFonts, \Nwdthemes\Revslider\Helper\Register $registerHelper)
    {
        $this->___init();
        parent::__construct($context, $customerGroupCollection, $framework, $query, $curl, $filesystemHelper, $images, $resource, $googleFonts, $registerHelper);
    }
