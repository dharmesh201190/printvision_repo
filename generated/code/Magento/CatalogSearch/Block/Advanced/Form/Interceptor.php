...
class Interceptor extends \Magento\CatalogSearch\Block\Advanced\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getSearchableAttributes()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSearchableAttributes();
        } else {
    ...
    public function getAttributeLabel($attribute)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getAttributeLabel', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getAttributeValidationClass($attribute)
    {
        ...
        if (!$pluginInfo) {
            return parent::getAttributeValidationClass($attribute);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeValue');
        if (!$pluginInfo) {
            return parent::getAttributeValue($attribute, $part);
        } else {
            return $this->___callPlugins('getAttributeValue', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAvailableCurrencies');
        if (!$pluginInfo) {
            return parent::getAvailableCurrencies();
        } else {
            return $this->___callPlugins('getAvailableCurrencies', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCurrency($attribute)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCurrency($attribute);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeInputType');
        if (!$pluginInfo) {
            return parent::getAttributeInputType($attribute);
        } else {
            return $this->___callPlugins('getAttributeInputType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeSelectElement');
        if (!$pluginInfo) {
            return parent::getAttributeSelectElement($attribute);
        } else {
            return $this->___callPlugins('getAttributeSelectElement', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeYesNoElement');
        if (!$pluginInfo) {
            return parent::getAttributeYesNoElement($attribute);
        } else {
            return $this->___callPlugins('getAttributeYesNoElement', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSearchPostUrl');
        if (!$pluginInfo) {
            return parent::getSearchPostUrl();
        } else {
            return $this->___callPlugins('getSearchPostUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDateInput');
        if (!$pluginInfo) {
            return parent::getDateInput($attribute, $part);
        } else {
            return $this->___callPlugins('getDateInput', func_get_args(), $pluginInfo);
        }
    }
