...
class Interceptor extends \Magento\SalesRule\Block\Adminhtml\Promo\Quote\Edit\Tab\Coupons implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCanSHow');
        if (!$pluginInfo) {
            return parent::setCanSHow($canShow);
        } else {
            return $this->___callPlugins('setCanSHow', func_get_args(), $pluginInfo);
        }
    }
