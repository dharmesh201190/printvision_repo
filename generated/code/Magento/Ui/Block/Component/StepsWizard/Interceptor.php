...
class Interceptor extends \Magento\Ui\Block\Component\StepsWizard implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStepComponents');
        if (!$pluginInfo) {
            return parent::getStepComponents();
        } else {
            return $this->___callPlugins('getStepComponents', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInitData');
        if (!$pluginInfo) {
            return parent::getInitData();
        } else {
            return $this->___callPlugins('getInitData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setInitData');
        if (!$pluginInfo) {
            return parent::setInitData($initData);
        } else {
            return $this->___callPlugins('setInitData', func_get_args(), $pluginInfo);
        }
    }
