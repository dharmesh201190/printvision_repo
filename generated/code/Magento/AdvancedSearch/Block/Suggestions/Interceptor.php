...
class Interceptor extends \Magento\AdvancedSearch\Block\Suggestions implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isShowResultsCount');
        if (!$pluginInfo) {
            return parent::isShowResultsCount();
        } else {
            return $this->___callPlugins('isShowResultsCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLink($queryText)
    {
        ...
        if (!$pluginInfo) {
            return parent::getLink($queryText);
        } else {
