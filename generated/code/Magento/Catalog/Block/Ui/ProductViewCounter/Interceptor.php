...
class Interceptor extends \Magento\Catalog\Block\Ui\ProductViewCounter implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentProductData');
        if (!$pluginInfo) {
            return parent::getCurrentProductData();
        } else {
            return $this->___callPlugins('getCurrentProductData', func_get_args(), $pluginInfo);
        }
    }
