...
class Interceptor extends \Magento\Catalog\Block\Adminhtml\Category\AssignProducts implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlockGrid');
        if (!$pluginInfo) {
            return parent::getBlockGrid();
        } else {
            return $this->___callPlugins('getBlockGrid', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsJson');
        if (!$pluginInfo) {
            return parent::getProductsJson();
        } else {
            return $this->___callPlugins('getProductsJson', func_get_args(), $pluginInfo);
        }
    }
