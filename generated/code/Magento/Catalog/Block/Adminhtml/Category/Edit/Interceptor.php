...
class Interceptor extends \Magento\Catalog\Block\Adminhtml\Category\Edit implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRefreshPathUrl');
        if (!$pluginInfo) {
            return parent::getRefreshPathUrl();
        } else {
            return $this->___callPlugins('getRefreshPathUrl', func_get_args(), $pluginInfo);
        }
    }
