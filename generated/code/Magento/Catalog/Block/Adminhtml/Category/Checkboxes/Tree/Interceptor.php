...
class Interceptor extends \Magento\Catalog\Block\Adminhtml\Category\Checkboxes\Tree implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCategoryIds');
        if (!$pluginInfo) {
            return parent::setCategoryIds($ids);
        } else {
            return $this->___callPlugins('setCategoryIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSuggestedCategoriesJson');
        if (!$pluginInfo) {
            return parent::getSuggestedCategoriesJson($namePart);
        } else {
            return $this->___callPlugins('getSuggestedCategoriesJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddRootButtonHtml');
        if (!$pluginInfo) {
            return parent::getAddRootButtonHtml();
        } else {
            return $this->___callPlugins('getAddRootButtonHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddSubButtonHtml');
        if (!$pluginInfo) {
            return parent::getAddSubButtonHtml();
        } else {
            return $this->___callPlugins('getAddSubButtonHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExpandButtonHtml');
        if (!$pluginInfo) {
            return parent::getExpandButtonHtml();
        } else {
            return $this->___callPlugins('getExpandButtonHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCollapseButtonHtml');
        if (!$pluginInfo) {
            return parent::getCollapseButtonHtml();
        } else {
            return $this->___callPlugins('getCollapseButtonHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreSwitcherHtml');
        if (!$pluginInfo) {
            return parent::getStoreSwitcherHtml();
        } else {
            return $this->___callPlugins('getStoreSwitcherHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLoadTreeUrl');
        if (!$pluginInfo) {
            return parent::getLoadTreeUrl($expanded);
        } else {
            return $this->___callPlugins('getLoadTreeUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNodesUrl');
        if (!$pluginInfo) {
            return parent::getNodesUrl();
        } else {
            return $this->___callPlugins('getNodesUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSwitchTreeUrl');
        if (!$pluginInfo) {
            return parent::getSwitchTreeUrl();
        } else {
            return $this->___callPlugins('getSwitchTreeUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsWasExpanded');
        if (!$pluginInfo) {
            return parent::getIsWasExpanded();
        } else {
            return $this->___callPlugins('getIsWasExpanded', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMoveUrl');
        if (!$pluginInfo) {
            return parent::getMoveUrl();
        } else {
            return $this->___callPlugins('getMoveUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getTree($parenNodeCategory = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getTree($parenNodeCategory);
        } else {
            return $this->___callPlugins('getTree', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTreeJson');
        if (!$pluginInfo) {
            return parent::getTreeJson($parenNodeCategory);
        } else {
            return $this->___callPlugins('getTreeJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBreadcrumbsJavascript');
        if (!$pluginInfo) {
            return parent::getBreadcrumbsJavascript($path, $javascriptVarName);
        } else {
            return $this->___callPlugins('getBreadcrumbsJavascript', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isClearEdit');
        if (!$pluginInfo) {
            return parent::isClearEdit();
        } else {
            return $this->___callPlugins('isClearEdit', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canAddRootCategory');
        if (!$pluginInfo) {
            return parent::canAddRootCategory();
        } else {
            return $this->___callPlugins('canAddRootCategory', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canAddSubCategory');
        if (!$pluginInfo) {
            return parent::canAddSubCategory();
        } else {
            return $this->___callPlugins('canAddSubCategory', func_get_args(), $pluginInfo);
        }
    }
