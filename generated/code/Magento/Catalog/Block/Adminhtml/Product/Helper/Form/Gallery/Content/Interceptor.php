...
class Interceptor extends \Magento\Catalog\Block\Adminhtml\Product\Helper\Form\Gallery\Content implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Framework\Json\EncoderInterface $jsonEncoder, \Magento\Catalog\Model\Product\Media\Config $mediaConfig, array $data = [], ?\Magento\Backend\Block\DataProviders\ImageUploadConfig $imageUploadConfigDataProvider = null)
    {
        $this->___init();
        parent::__construct($context, $jsonEncoder, $mediaConfig, $data, $imageUploadConfigDataProvider);
    }
