...
class Interceptor extends \Magento\Downloadable\Block\Sales\Order\Email\Items\Order\Downloadable implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPurchasedLinkUrl');
        if (!$pluginInfo) {
            return parent::getPurchasedLinkUrl($item);
        } else {
            return $this->___callPlugins('getPurchasedLinkUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getValueHtml($value)
    {
        ...
        if (!$pluginInfo) {
            return parent::getValueHtml($value);
        } else {
     ...
     * {@inheritdoc}
     */
    public function getItemPrice(\Magento\Sales\Model\Order\Item $item)
    {
