...
class Interceptor extends \Magento\Downloadable\Block\Checkout\Success implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDownloadableProductsUrl');
        if (!$pluginInfo) {
            return parent::getDownloadableProductsUrl();
        } else {
            return $this->___callPlugins('getDownloadableProductsUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAdditionalInfoHtml');
        if (!$pluginInfo) {
            return parent::getAdditionalInfoHtml();
        } else {
            return $this->___callPlugins('getAdditionalInfoHtml', func_get_args(), $pluginInfo);
        }
    }
