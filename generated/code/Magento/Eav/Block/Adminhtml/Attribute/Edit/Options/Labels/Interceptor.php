...
class Interceptor extends \Magento\Eav\Block\Adminhtml\Attribute\Edit\Options\Labels implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLabelValues');
        if (!$pluginInfo) {
            return parent::getLabelValues();
        } else {
            return $this->___callPlugins('getLabelValues', func_get_args(), $pluginInfo);
        }
    }
