...
class Interceptor extends \Magento\Eav\Block\Adminhtml\Attribute\Edit\Js implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getComaptibleInputTypes');
        if (!$pluginInfo) {
            return parent::getComaptibleInputTypes();
        } else {
            return $this->___callPlugins('getComaptibleInputTypes', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCompatibleInputTypes');
        if (!$pluginInfo) {
            return parent::getCompatibleInputTypes();
        } else {
            return $this->___callPlugins('getCompatibleInputTypes', func_get_args(), $pluginInfo);
        }
    }
