...
class Interceptor extends \Magento\Bundle\Block\Sales\Order\Items\Renderer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemOptions');
        if (!$pluginInfo) {
            return parent::getItemOptions();
        } else {
            return $this->___callPlugins('getItemOptions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemRowTotalHtml');
        if (!$pluginInfo) {
            return parent::getItemRowTotalHtml($item);
        } else {
            return $this->___callPlugins('getItemRowTotalHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemRowTotalAfterDiscountHtml');
        if (!$pluginInfo) {
            return parent::getItemRowTotalAfterDiscountHtml($item);
        } else {
            return $this->___callPlugins('getItemRowTotalAfterDiscountHtml', func_get_args(), $pluginInfo);
        }
    }
