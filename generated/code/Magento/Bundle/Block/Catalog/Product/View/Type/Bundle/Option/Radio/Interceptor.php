...
class Interceptor extends \Magento\Bundle\Block\Catalog\Product\View\Type\Bundle\Option\Radio implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function showSingle()
    {
        ...
        if (!$pluginInfo) {
            return parent::showSingle();
        } else {
            return $this->___callPlugins('showSingle', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDefaultValues()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getDefaultValues', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isSelected($selection)
    {
        ...
        if (!$pluginInfo) {
            return parent::isSelected($selection);
        } else {
            return $this->___callPlugins('isSelected', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSelectionQtyTitlePrice($selection, $includeContainer = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSelectionQtyTitlePrice($selection, $includeContainer);
        } else {
            return $this->___callPlugins('getSelectionQtyTitlePrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSelectionPrice($selection)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSelectionPrice($selection);
        } else {
            return $this->___callPlugins('getSelectionPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSelectionTitlePrice($selection, $includeContainer = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSelectionTitlePrice($selection, $includeContainer);
        } else {
            return $this->___callPlugins('getSelectionTitlePrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setValidationContainer($elementId, $containerId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setValidationContainer($elementId, $containerId);
        } else {
            return $this->___callPlugins('setValidationContainer', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renderPriceString($selection, $includeContainer = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::renderPriceString($selection, $includeContainer);
        } else {
            return $this->___callPlugins('renderPriceString', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getWebsite($storeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getWebsite($storeId);
        } else {
    ...
    public function getDisplayMinimalPrice()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getDisplayMinimalPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setIdSuffix($idSuffix)
    {
        ...
        if (!$pluginInfo) {
            return parent::setIdSuffix($idSuffix);
        } else {
            return $this->___callPlugins('setIdSuffix', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getIdSuffix()
    {
        ...
        if (!$pluginInfo) {
            return parent::getIdSuffix();
        } else {
            return $this->___callPlugins('getIdSuffix', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRealPriceJs($product)
    {
        ...
        if (!$pluginInfo) {
            return parent::getRealPriceJs($product);
        } else {
            return $this->___callPlugins('getRealPriceJs', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function prepareSku($sku)
    {
        ...
        if (!$pluginInfo) {
            return parent::prepareSku($sku);
        } else {
            return $this->___callPlugins('prepareSku', func_get_args(), $pluginInfo);
        }
    }
