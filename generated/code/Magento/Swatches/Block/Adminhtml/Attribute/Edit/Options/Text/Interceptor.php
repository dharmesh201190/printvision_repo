...
class Interceptor extends \Magento\Swatches\Block\Adminhtml\Attribute\Edit\Options\Text implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoreOptionValues');
        if (!$pluginInfo) {
            return parent::getStoreOptionValues($storeId);
        } else {
            return $this->___callPlugins('getStoreOptionValues', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canManageOptionDefaultOnly');
        if (!$pluginInfo) {
            return parent::canManageOptionDefaultOnly();
        } else {
            return $this->___callPlugins('canManageOptionDefaultOnly', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStoresSortedBySortOrder');
        if (!$pluginInfo) {
            return parent::getStoresSortedBySortOrder();
        } else {
            return $this->___callPlugins('getStoresSortedBySortOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getOptionValues()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getOptionValues', func_get_args(), $pluginInfo);
        }
    }
