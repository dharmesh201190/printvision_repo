...
class Interceptor extends \Magento\Backend\Block\Widget\Grid\Massaction\Item implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setMassaction');
        if (!$pluginInfo) {
            return parent::setMassaction($massaction);
        } else {
            return $this->___callPlugins('setMassaction', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMassaction');
        if (!$pluginInfo) {
            return parent::getMassaction();
        } else {
            return $this->___callPlugins('getMassaction', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAdditionalActionBlock');
        if (!$pluginInfo) {
            return parent::setAdditionalActionBlock($block);
        } else {
            return $this->___callPlugins('setAdditionalActionBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAdditionalActionBlock');
        if (!$pluginInfo) {
            return parent::getAdditionalActionBlock();
        } else {
            return $this->___callPlugins('getAdditionalActionBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAdditionalActionBlockHtml');
        if (!$pluginInfo) {
            return parent::getAdditionalActionBlockHtml();
        } else {
            return $this->___callPlugins('getAdditionalActionBlockHtml', func_get_args(), $pluginInfo);
        }
    }
