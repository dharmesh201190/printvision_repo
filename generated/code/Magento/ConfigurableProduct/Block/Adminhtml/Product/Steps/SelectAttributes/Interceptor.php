...
class Interceptor extends \Magento\ConfigurableProduct\Block\Adminhtml\Product\Steps\SelectAttributes implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddNewAttributeButton');
        if (!$pluginInfo) {
            return parent::getAddNewAttributeButton($dataProvider);
        } else {
            return $this->___callPlugins('getAddNewAttributeButton', func_get_args(), $pluginInfo);
        }
    }
