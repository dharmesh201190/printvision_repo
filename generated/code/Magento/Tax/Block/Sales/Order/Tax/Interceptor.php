...
class Interceptor extends \Magento\Tax\Block\Sales\Order\Tax implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function displayFullSummary()
    {
        ...
        if (!$pluginInfo) {
            return parent::displayFullSummary();
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'initTotals');
        if (!$pluginInfo) {
            return parent::initTotals();
        } else {
            return $this->___callPlugins('initTotals', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLabelProperties');
        if (!$pluginInfo) {
            return parent::getLabelProperties();
        } else {
            return $this->___callPlugins('getLabelProperties', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getValueProperties');
        if (!$pluginInfo) {
            return parent::getValueProperties();
        } else {
            return $this->___callPlugins('getValueProperties', func_get_args(), $pluginInfo);
        }
    }
