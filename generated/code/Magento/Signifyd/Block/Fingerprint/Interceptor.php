...
class Interceptor extends \Magento\Signifyd\Block\Fingerprint implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSignifydOrderSessionId');
        if (!$pluginInfo) {
            return parent::getSignifydOrderSessionId();
        } else {
            return $this->___callPlugins('getSignifydOrderSessionId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isModuleActive');
        if (!$pluginInfo) {
            return parent::isModuleActive();
        } else {
            return $this->___callPlugins('isModuleActive', func_get_args(), $pluginInfo);
        }
    }
