...
class Interceptor extends \Mirasvit\SearchAutocomplete\Block\Injection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCssStyles');
        if (!$pluginInfo) {
            return parent::getCssStyles();
        } else {
            return $this->___callPlugins('getCssStyles', func_get_args(), $pluginInfo);
        }
    }
