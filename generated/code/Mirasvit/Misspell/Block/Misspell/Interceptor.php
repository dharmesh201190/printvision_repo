...
class Interceptor extends \Mirasvit\Misspell\Block\Misspell implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getQueryUrl');
        if (!$pluginInfo) {
            return parent::getQueryUrl($query);
        } else {
            return $this->___callPlugins('getQueryUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function highlight($new, $old, $tag = 'em')
    {
        ...
        if (!$pluginInfo) {
            return parent::highlight($new, $old, $tag);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOriginalQueryText');
        if (!$pluginInfo) {
            return parent::getOriginalQueryText();
        } else {
            return $this->___callPlugins('getOriginalQueryText', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMisspellText');
        if (!$pluginInfo) {
            return parent::getMisspellText();
        } else {
            return $this->___callPlugins('getMisspellText', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFallbackText');
        if (!$pluginInfo) {
            return parent::getFallbackText();
        } else {
            return $this->___callPlugins('getFallbackText', func_get_args(), $pluginInfo);
        }
    }
