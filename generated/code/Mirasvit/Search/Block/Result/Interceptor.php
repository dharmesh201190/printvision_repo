...
class Interceptor extends \Mirasvit\Search\Block\Result implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Mirasvit\Search\Api\Repository\IndexRepositoryInterface $indexRepository, \Mirasvit\Search\Api\Service\IndexServiceInterface $indexService, \Magento\Search\Model\QueryFactory $queryFactory, \Mirasvit\Search\Model\Config $config, \Magento\Framework\Registry $registry, \Magento\Framework\Encryption\UrlCoder $urlCoder)
    {
        $this->___init();
        parent::__construct($context, $indexRepository, $indexService, $queryFactory, $config, $registry, $urlCoder);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIndices');
        if (!$pluginInfo) {
            return parent::getIndices();
        } else {
            return $this->___callPlugins('getIndices', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentContent');
        if (!$pluginInfo) {
            return parent::getCurrentContent();
        } else {
            return $this->___callPlugins('getCurrentContent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContentBlock');
        if (!$pluginInfo) {
            return parent::getContentBlock($index);
        } else {
            return $this->___callPlugins('getContentBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFirstMatchedIndex');
        if (!$pluginInfo) {
            return parent::getFirstMatchedIndex();
        } else {
            return $this->___callPlugins('getFirstMatchedIndex', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentIndex');
        if (!$pluginInfo) {
            return parent::getCurrentIndex();
        } else {
            return $this->___callPlugins('getCurrentIndex', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentIndexSize');
        if (!$pluginInfo) {
            return parent::getCurrentIndexSize();
        } else {
            return $this->___callPlugins('getCurrentIndexSize', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getSearchCollection(\Mirasvit\Search\Api\Data\IndexInterface $index)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSearchCollection');
        if (!$pluginInfo) {
            return parent::getSearchCollection($index);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIndexUrl');
        if (!$pluginInfo) {
            return parent::getIndexUrl($index);
        } else {
            return $this->___callPlugins('getIndexUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMinCollectionSize');
        if (!$pluginInfo) {
            return parent::getMinCollectionSize();
        } else {
            return $this->___callPlugins('getMinCollectionSize', func_get_args(), $pluginInfo);
        }
    }
