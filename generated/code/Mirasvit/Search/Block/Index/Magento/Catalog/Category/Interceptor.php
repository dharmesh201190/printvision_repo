...
class Interceptor extends \Mirasvit\Search\Block\Index\Magento\Catalog\Category implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getFullPath($categoryId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getFullPath($categoryId);
        } else {
            return $this->___callPlugins('getFullPath', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryImage');
        if (!$pluginInfo) {
            return parent::getCategoryImage($item);
        } else {
            return $this->___callPlugins('getCategoryImage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPager');
        if (!$pluginInfo) {
            return parent::getPager();
        } else {
            return $this->___callPlugins('getPager', func_get_args(), $pluginInfo);
        }
    }
