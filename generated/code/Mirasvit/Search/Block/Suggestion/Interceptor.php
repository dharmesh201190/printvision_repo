...
class Interceptor extends \Mirasvit\Search\Block\Suggestion implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSuggestedTerms');
        if (!$pluginInfo) {
            return parent::getSuggestedTerms();
        } else {
            return $this->___callPlugins('getSuggestedTerms', func_get_args(), $pluginInfo);
        }
    }
