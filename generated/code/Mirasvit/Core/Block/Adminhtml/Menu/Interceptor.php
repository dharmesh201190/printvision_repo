...
class Interceptor extends \Mirasvit\Core\Block\Adminhtml\Menu implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getActiveMenu');
        if (!$pluginInfo) {
            return parent::getActiveMenu();
        } else {
            return $this->___callPlugins('getActiveMenu', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getActiveTitle');
        if (!$pluginInfo) {
            return parent::getActiveTitle();
        } else {
            return $this->___callPlugins('getActiveTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsByModuleName');
        if (!$pluginInfo) {
            return parent::getItemsByModuleName($moduleName);
        } else {
            return $this->___callPlugins('getItemsByModuleName', func_get_args(), $pluginInfo);
        }
    }
