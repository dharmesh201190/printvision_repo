...
class Interceptor extends \Magefan\Blog\Block\Catalog\Product\RelatedPosts implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayPosts');
        if (!$pluginInfo) {
            return parent::displayPosts();
        } else {
            return $this->___callPlugins('displayPosts', func_get_args(), $pluginInfo);
        }
    }
