...
class Interceptor extends \Magefan\Blog\Block\Widget\Recent implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShorContent');
        if (!$pluginInfo) {
            return parent::getShorContent($post);
        } else {
            return $this->___callPlugins('getShorContent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCollectionOrderField');
        if (!$pluginInfo) {
            return parent::getCollectionOrderField();
        } else {
            return $this->___callPlugins('getCollectionOrderField', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCollectionOrderDirection');
        if (!$pluginInfo) {
            return parent::getCollectionOrderDirection();
        } else {
            return $this->___callPlugins('getCollectionOrderDirection', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPostCollection()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getPostCollection', func_get_args(), $pluginInfo);
        }
    }
