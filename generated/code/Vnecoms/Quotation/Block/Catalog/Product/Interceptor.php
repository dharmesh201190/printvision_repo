<?php
namespace Vnecoms\Quotation\Block\Catalog\Product;

/**
 * Interceptor class for @see \Vnecoms\Quotation\Block\Catalog\Product
 */
class Interceptor extends \Vnecoms\Quotation\Block\Catalog\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Registry $coreRegistry, \Magento\Catalog\Api\ProductRepositoryInterface $productRepository, \Magento\Framework\Url\EncoderInterface $urlEncoder, \Vnecoms\Quotation\Helper\Data $helper, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $coreRegistry, $productRepository, $urlEncoder, $helper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddToQuoteUrl');
        if (!$pluginInfo) {
            return parent::getAddToQuoteUrl($additional);
        } else {
            return $this->___callPlugins('getAddToQuoteUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isEnabledAddToCart');
        if (!$pluginInfo) {
            return parent::isEnabledAddToCart();
        } else {
            return $this->___callPlugins('isEnabledAddToCart', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isEnabledAddToQuote');
        if (!$pluginInfo) {
            return parent::isEnabledAddToQuote();
        } else {
            return $this->___callPlugins('isEnabledAddToQuote', func_get_args(), $pluginInfo);
        }
    }
