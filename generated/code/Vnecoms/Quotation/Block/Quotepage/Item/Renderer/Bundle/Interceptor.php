<?php
namespace Vnecoms\Quotation\Block\Quotepage\Item\Renderer\Bundle;

/**
 * Interceptor class for @see \Vnecoms\Quotation\Block\Quotepage\Item\Renderer\Bundle
 */
class Interceptor extends \Vnecoms\Quotation\Block\Quotepage\Item\Renderer\Bundle implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Catalog\Helper\Product\Configuration $productConfig, \Vnecoms\Quotation\Model\Session $session, \Magento\Catalog\Block\Product\ImageBuilder $imageBuilder, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Framework\Message\ManagerInterface $messageManager, \Magento\Framework\Pricing\PriceCurrencyInterface $priceCurrency, \Magento\Framework\Module\Manager $moduleManager, \Magento\Framework\View\Element\Message\InterpretationStrategyInterface $messageInterpretationStrategy, \Magento\Framework\Stdlib\StringUtils $stringUtils, \Magento\Bundle\Helper\Catalog\Product\Configuration $configuration, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $productConfig, $session, $imageBuilder, $urlHelper, $messageManager, $priceCurrency, $moduleManager, $messageInterpretationStrategy, $stringUtils, $configuration, $data);
    }
