<?php
namespace Vnecoms\Quotation\Block\Quotepage\Item\Renderer\Downloadable;

/**
 * Interceptor class for @see \Vnecoms\Quotation\Block\Quotepage\Item\Renderer\Downloadable
 */
class Interceptor extends \Vnecoms\Quotation\Block\Quotepage\Item\Renderer\Downloadable implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Catalog\Helper\Product\Configuration $productConfig, \Vnecoms\Quotation\Model\Session $session, \Magento\Catalog\Block\Product\ImageBuilder $imageBuilder, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Framework\Message\ManagerInterface $messageManager, \Magento\Framework\Pricing\PriceCurrencyInterface $priceCurrency, \Magento\Framework\Module\Manager $moduleManager, \Magento\Framework\View\Element\Message\InterpretationStrategyInterface $messageInterpretationStrategy, \Magento\Framework\Stdlib\StringUtils $stringUtils, \Magento\Downloadable\Helper\Catalog\Product\Configuration $downloadableProductConfiguration, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $productConfig, $session, $imageBuilder, $urlHelper, $messageManager, $priceCurrency, $moduleManager, $messageInterpretationStrategy, $stringUtils, $downloadableProductConfiguration, $data);
    }
     ...
     * {@inheritdoc}
     */
    public function getUnitPriceHtml(\Vnecoms\Quotation\Model\Item $item)
    {
     ...
     * {@inheritdoc}
     */
    public function getRowTotalHtml(\Vnecoms\Quotation\Model\Item $item)
    {
     ...
     * {@inheritdoc}
     */
    public function getActions(\Vnecoms\Quotation\Model\Item $item)
    {
    ...
    public function getItemPriceHtml($item = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getItemPriceHtml($item);
        } else {
