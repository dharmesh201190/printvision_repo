<?php
namespace Vnecoms\Quotation\Block\Quotepage\Sidebar;

/**
 * Interceptor class for @see \Vnecoms\Quotation\Block\Quotepage\Sidebar
 */
class Interceptor extends \Vnecoms\Quotation\Block\Quotepage\Sidebar implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Data\Form\FormKey $formKey, \Vnecoms\Quotation\Helper\Data $helper, \Vnecoms\Quotation\Model\QuoteConfigProvider $configProvider, \Magento\Customer\Model\Session $customerSession, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $formKey, $helper, $configProvider, $customerSession, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getQuotationConfig');
        if (!$pluginInfo) {
            return parent::getQuotationConfig();
        } else {
            return $this->___callPlugins('getQuotationConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showLoginRequired');
        if (!$pluginInfo) {
            return parent::showLoginRequired();
        } else {
            return $this->___callPlugins('showLoginRequired', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isEnabledTelephone');
        if (!$pluginInfo) {
            return parent::isEnabledTelephone();
        } else {
            return $this->___callPlugins('isEnabledTelephone', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isRequiredTelephone');
        if (!$pluginInfo) {
            return parent::isRequiredTelephone();
        } else {
            return $this->___callPlugins('isRequiredTelephone', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isEnabledCompany');
        if (!$pluginInfo) {
            return parent::isEnabledCompany();
        } else {
            return $this->___callPlugins('isEnabledCompany', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isRequiredCompany');
        if (!$pluginInfo) {
            return parent::isRequiredCompany();
        } else {
            return $this->___callPlugins('isRequiredCompany', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isEnabledTaxId');
        if (!$pluginInfo) {
            return parent::isEnabledTaxId();
        } else {
            return $this->___callPlugins('isEnabledTaxId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isRequiredTaxId');
        if (!$pluginInfo) {
            return parent::isRequiredTaxId();
        } else {
            return $this->___callPlugins('isRequiredTaxId', func_get_args(), $pluginInfo);
        }
    }
