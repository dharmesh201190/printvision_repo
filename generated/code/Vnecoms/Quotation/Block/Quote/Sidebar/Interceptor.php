<?php
namespace Vnecoms\Quotation\Block\Quote\Sidebar;

/**
 * Interceptor class for @see \Vnecoms\Quotation\Block\Quote\Sidebar
 */
class Interceptor extends \Vnecoms\Quotation\Block\Quote\Sidebar implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Customer\Model\Session $customerSession, \Vnecoms\Quotation\Model\Session $session, \Magento\Catalog\Helper\Image $imageHelper, \Magento\Customer\CustomerData\JsLayoutDataProviderPoolInterface $jsLayoutDataProvider, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $customerSession, $session, $imageHelper, $jsLayoutDataProvider, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddQuoteActionUrl');
        if (!$pluginInfo) {
            return parent::getAddQuoteActionUrl();
        } else {
            return $this->___callPlugins('getAddQuoteActionUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getQuoteRequestPageUrl');
        if (!$pluginInfo) {
            return parent::getQuoteRequestPageUrl();
        } else {
            return $this->___callPlugins('getQuoteRequestPageUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getQuoteUrl');
        if (!$pluginInfo) {
            return parent::getQuoteUrl();
        } else {
            return $this->___callPlugins('getQuoteUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRequestUrl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getRequestUrl', func_get_args(), $pluginInfo);
        }
    }
