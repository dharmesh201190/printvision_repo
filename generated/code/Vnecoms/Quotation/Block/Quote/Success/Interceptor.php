<?php
namespace Vnecoms\Quotation\Block\Quote\Success;

/**
 * Interceptor class for @see \Vnecoms\Quotation\Block\Quote\Success
 */
class Interceptor extends \Vnecoms\Quotation\Block\Quote\Success implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Vnecoms\Quotation\Model\Session $quoteSession, \Magento\Framework\App\Http\Context $httpContext, \Vnecoms\Quotation\Api\QuoteRepositoryInterface $quoteRepository, \Magento\Customer\Model\Session $customerSession, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $quoteSession, $httpContext, $quoteRepository, $customerSession, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canViewQuote');
        if (!$pluginInfo) {
            return parent::canViewQuote($quote);
        } else {
            return $this->___callPlugins('canViewQuote', func_get_args(), $pluginInfo);
        }
    }
