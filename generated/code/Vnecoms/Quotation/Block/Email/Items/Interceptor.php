<?php
namespace Vnecoms\Quotation\Block\Email\Items;

/**
 * Interceptor class for @see \Vnecoms\Quotation\Block\Email\Items
 */
class Interceptor extends \Vnecoms\Quotation\Block\Email\Items implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Vnecoms\Quotation\Model\Session $session, \Magento\Framework\Registry $registry, \Vnecoms\Quotation\Helper\Data $helper, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $session, $registry, $helper, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getJsLayoutMessage');
        if (!$pluginInfo) {
            return parent::getJsLayoutMessage();
        } else {
            return $this->___callPlugins('getJsLayoutMessage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMessagesJson');
        if (!$pluginInfo) {
            return parent::getMessagesJson();
        } else {
            return $this->___callPlugins('getMessagesJson', func_get_args(), $pluginInfo);
        }
    }
