<?php
namespace Vnecoms\Quotation\Block\Guest\Form;

/**
 * Interceptor class for @see \Vnecoms\Quotation\Block\Guest\Form
 */
class Interceptor extends \Vnecoms\Quotation\Block\Guest\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTypeSelectHtml');
        if (!$pluginInfo) {
            return parent::getTypeSelectHtml();
        } else {
            return $this->___callPlugins('getTypeSelectHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFormAction()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getFormAction', func_get_args(), $pluginInfo);
        }
    }
