<?php
namespace Swissup\Easytabs\Block\ProductTabs;

/**
 * Interceptor class for @see \Swissup\Easytabs\Block\ProductTabs
 */
class Interceptor extends \Swissup\Easytabs\Block\ProductTabs implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Swissup\Easytabs\Model\ResourceModel\Entity\CollectionFactory $tabsCollectionFactory, \Swissup\Easytabs\Model\Template\Filter $templateFilter, \Magento\Framework\Json\EncoderInterface $jsonEncoder, \Magento\Framework\Module\FullModuleList $fullModuleList, \Magento\Framework\Module\Manager $moduleManager, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $tabsCollectionFactory, $templateFilter, $jsonEncoder, $fullModuleList, $moduleManager, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInitOptions');
        if (!$pluginInfo) {
            return parent::getInitOptions();
        } else {
            return $this->___callPlugins('getInitOptions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTabsLayout');
        if (!$pluginInfo) {
            return parent::getTabsLayout();
        } else {
            return $this->___callPlugins('getTabsLayout', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function addTab($alias, $title, $block = false, $template = false, $attributes = [])
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addTab');
        if (!$pluginInfo) {
            return parent::addTab($alias, $title, $block, $template, $attributes);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isEmptyString');
        if (!$pluginInfo) {
            return parent::isEmptyString($content);
        } else {
            return $this->___callPlugins('isEmptyString', func_get_args(), $pluginInfo);
        }
    }
