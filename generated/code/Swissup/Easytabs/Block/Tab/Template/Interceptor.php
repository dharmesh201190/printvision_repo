<?php
namespace Swissup\Easytabs\Block\Tab\Template;

/**
 * Interceptor class for @see \Swissup\Easytabs\Block\Tab\Template
 */
class Interceptor extends \Swissup\Easytabs\Block\Tab\Template implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTabBlock');
        if (!$pluginInfo) {
            return parent::getTabBlock();
        } else {
            return $this->___callPlugins('getTabBlock', func_get_args(), $pluginInfo);
        }
    }
