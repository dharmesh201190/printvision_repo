<?php
namespace Prince\Productattach\Block\Attachment;

/**
 * Interceptor class for @see \Prince\Productattach\Block\Attachment
 */
class Interceptor extends \Prince\Productattach\Block\Attachment implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Customer\Model\Session $customerSession, \Prince\Productattach\Model\ResourceModel\Productattach\CollectionFactory $productattachCollectionFactory, \Prince\Productattach\Model\ResourceModel\Fileicon\CollectionFactory $fileiconCollectionFactory, \Prince\Productattach\Helper\Data $dataHelper, \Magento\Framework\Registry $registry, \Magento\Framework\App\Http\Context $httpContext, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $customerSession, $productattachCollectionFactory, $fileiconCollectionFactory, $dataHelper, $registry, $httpContext, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttachment');
        if (!$pluginInfo) {
            return parent::getAttachment($productId);
        } else {
            return $this->___callPlugins('getAttachment', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttachmentUrl');
        if (!$pluginInfo) {
            return parent::getAttachmentUrl($attachment);
        } else {
            return $this->___callPlugins('getAttachmentUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentId');
        if (!$pluginInfo) {
            return parent::getCurrentId();
        } else {
            return $this->___callPlugins('getCurrentId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFileIcon');
        if (!$pluginInfo) {
            return parent::getFileIcon($fileExt);
        } else {
            return $this->___callPlugins('getFileIcon', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIconExt');
        if (!$pluginInfo) {
            return parent::getIconExt($fileExt);
        } else {
            return $this->___callPlugins('getIconExt', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinkIcon');
        if (!$pluginInfo) {
            return parent::getLinkIcon();
        } else {
            return $this->___callPlugins('getLinkIcon', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFileSize($attachment)
    {
        ...
        if (!$pluginInfo) {
            return parent::getFileSize($attachment);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTabName');
        if (!$pluginInfo) {
            return parent::getTabName();
        } else {
            return $this->___callPlugins('getTabName', func_get_args(), $pluginInfo);
        }
    }
