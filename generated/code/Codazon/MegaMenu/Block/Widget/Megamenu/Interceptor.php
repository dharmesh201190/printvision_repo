<?php
namespace Codazon\MegaMenu\Block\Widget\Megamenu;

/**
 * Interceptor class for @see \Codazon\MegaMenu\Block\Widget\Megamenu
 */
class Interceptor extends \Codazon\MegaMenu\Block\Widget\Megamenu implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Codazon\MegaMenu\Model\MegamenuFactory $megamenuFactory, \Magento\Cms\Model\Template\FilterProvider $filterProvider, \Magento\Cms\Model\BlockFactory $blockFactory, \Magento\Framework\App\Http\Context $httpContext, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $megamenuFactory, $filterProvider, $blockFactory, $httpContext, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMenuTree');
        if (!$pluginInfo) {
            return parent::getMenuTree();
        } else {
            return $this->___callPlugins('getMenuTree', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMenuObject');
        if (!$pluginInfo) {
            return parent::getMenuObject();
        } else {
            return $this->___callPlugins('getMenuObject', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setMenuObject');
        if (!$pluginInfo) {
            return parent::setMenuObject($menuObject);
        } else {
            return $this->___callPlugins('setMenuObject', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMenuHtml($items)
    {
        ...
        if (!$pluginInfo) {
            return parent::getMenuHtml($items);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getParentType');
        if (!$pluginInfo) {
            return parent::getParentType($items, $i);
        } else {
            return $this->___callPlugins('getParentType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIcon');
        if (!$pluginInfo) {
            return parent::getIcon($content);
        } else {
            return $this->___callPlugins('getIcon', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function hasChildren($items, $i)
    {
        ...
        if (!$pluginInfo) {
            return parent::hasChildren($items, $i);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBackgroundStyle');
        if (!$pluginInfo) {
            return parent::getBackgroundStyle($content);
        } else {
            return $this->___callPlugins('getBackgroundStyle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMenuContentArray');
        if (!$pluginInfo) {
            return parent::getMenuContentArray();
        } else {
            return $this->___callPlugins('getMenuContentArray', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemCSSClass');
        if (!$pluginInfo) {
            return parent::getItemCSSClass($item);
        } else {
            return $this->___callPlugins('getItemCSSClass', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryTree');
        if (!$pluginInfo) {
            return parent::getCategoryTree();
        } else {
            return $this->___callPlugins('getCategoryTree', func_get_args(), $pluginInfo);
        }
    }
