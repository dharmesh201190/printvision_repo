<?php
namespace Codazon\ThemeOptions\Block\SearchInCategory;

/**
 * Interceptor class for @see \Codazon\ThemeOptions\Block\SearchInCategory
 */
class Interceptor extends \Codazon\ThemeOptions\Block\SearchInCategory implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Data\Tree\NodeFactory $nodeFactory, \Magento\Framework\Data\TreeFactory $treeFactory, \Codazon\ThemeOptions\Helper\Category $catalogCategory, \Magento\Catalog\Model\Indexer\Category\Flat\State $categoryFlatState, \Magento\Catalog\Observer\MenuCategoryData $menuCategoryData, array $data = [])
    {
        $this->___init();
