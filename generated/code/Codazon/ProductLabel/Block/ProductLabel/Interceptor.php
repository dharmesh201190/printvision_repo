<?php
namespace Codazon\ProductLabel\Block\ProductLabel;

/**
 * Interceptor class for @see \Codazon\ProductLabel\Block\ProductLabel
 */
class Interceptor extends \Codazon\ProductLabel\Block\ProductLabel implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addObject');
        if (!$pluginInfo) {
            return parent::addObject($_object);
        } else {
            return $this->___callPlugins('addObject', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getObject');
        if (!$pluginInfo) {
            return parent::getObject();
        } else {
            return $this->___callPlugins('getObject', func_get_args(), $pluginInfo);
        }
    }
