...
class Interceptor extends \Codazon\Lookbookpro\Model\ResourceModel\Lookbook implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getItemsPosition($lookbook)
    {
        ...
        if (!$pluginInfo) {
            return parent::getItemsPosition($lookbook);
        } else {
            return $this->___callPlugins('getItemsPosition', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLookbookItemGroupTable()
    {
        ...
        if (!$pluginInfo) {
            return parent::getLookbookItemGroupTable();
        } else {
            return $this->___callPlugins('getLookbookItemGroupTable', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLookbookCategoryTable()
    {
        ...
        if (!$pluginInfo) {
            return parent::getLookbookCategoryTable();
        } else {
            return $this->___callPlugins('getLookbookCategoryTable', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCategoriesPosition($lookbook)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCategoriesPosition($lookbook);
        } else {
            return $this->___callPlugins('getCategoriesPosition', func_get_args(), $pluginInfo);
        }
    }
