<?php
namespace Codazon\Shopbybrandpro\Block\Brand\BrandInformation;

/**
 * Interceptor class for @see \Codazon\Shopbybrandpro\Block\Brand\BrandInformation
 */
class Interceptor extends \Codazon\Shopbybrandpro\Block\Brand\BrandInformation implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Registry $registry, \Codazon\Shopbybrandpro\Helper\Data $helper, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandAttributeCode');
        if (!$pluginInfo) {
            return parent::getBrandAttributeCode();
        } else {
            return $this->___callPlugins('getBrandAttributeCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandOfCurrentProduct');
        if (!$pluginInfo) {
            return parent::getBrandOfCurrentProduct();
        } else {
            return $this->___callPlugins('getBrandOfCurrentProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandLabel');
        if (!$pluginInfo) {
            return parent::getBrandLabel();
        } else {
            return $this->___callPlugins('getBrandLabel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandByProduct');
        if (!$pluginInfo) {
            return parent::getBrandByProduct($product);
        } else {
            return $this->___callPlugins('getBrandByProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCoverImage');
        if (!$pluginInfo) {
            return parent::getCoverImage($brand, $options);
        } else {
            return $this->___callPlugins('getCoverImage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandImage');
        if (!$pluginInfo) {
            return parent::getBrandImage($brand, $type, $options);
        } else {
            return $this->___callPlugins('getBrandImage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'limitStringLength');
        if (!$pluginInfo) {
            return parent::limitStringLength($string, $length);
        } else {
            return $this->___callPlugins('limitStringLength', func_get_args(), $pluginInfo);
        }
    }
