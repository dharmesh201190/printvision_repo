<?php
namespace Bss\FacebookPixel\Block\Code;

/**
 * Interceptor class for @see \Bss\FacebookPixel\Block\Code
 */
class Interceptor extends \Bss\FacebookPixel\Block\Code implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Bss\FacebookPixel\Helper\Data $helper, \Magento\Framework\Registry $coreRegistry, \Magento\Catalog\Helper\Data $catalogHelper, \Magento\Checkout\Model\SessionFactory $checkoutSession, \Bss\FacebookPixel\Model\SessionFactory $fbPixelSession, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $helper, $coreRegistry, $catalogHelper, $checkoutSession, $fbPixelSession, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'checkDisable');
        if (!$pluginInfo) {
            return parent::checkDisable();
        } else {
            return $this->___callPlugins('checkDisable', func_get_args(), $pluginInfo);
        }
    }
